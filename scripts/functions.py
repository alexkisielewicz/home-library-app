...
def remove_book():
    ...
    """
    database_check()  # checks if DB is not empty
    ...
    # user is asked to select that book. User is asked to confirm the choice
    # before deletion. The input is validated. Book is removed if positive
    # answer is given. Database is re-sorted to keep ascending order.
                ...
                if validate_yes_no(are_you_sure):
                    ...
                    if "y" in are_you_sure or "Y" in are_you_sure:
                        ...
                        print(Fore.LIGHTGREEN_EX
                              + "Book removed. Database updated successfully."
                              + Style.RESET_ALL)
                        break
...
def edit_book():
    ...
    while True:
        ...
        if user_choice in allowed_input:
            ...
            # what data he wants to edit. Using this code in the loop allows
            # user to edit details one after another in any selected order.
            while True:
                print_edited_book()
                print(Fore.LIGHTGREEN_EX + """
                1. Title
                ...
                """ + Style.RESET_ALL)
                user_choice = input(Fore.LIGHTYELLOW_EX
                                    + "What do you want to edit? Select 1-6: "
                                    + Style.RESET_ALL)
                validate_num_range(user_choice, 1, 6)

                if user_choice == "1":
                    # if user choose to edit the title, function check_prefix
                    # converts the title given by the user if it contains
                    # "The ".
                    title = validate_string(Fore.LIGHTCYAN_EX
                                            + "Please update book's title: "
                                            + Style.RESET_ALL,
                                            constants.TITLE_MAX_LEN, "title")
                    title = check_title_prefix(title)
                    ...
                    print(Fore.LIGHTGREEN_EX
                          ...
                          + Style.RESET_ALL)
                    print(Fore.LIGHTYELLOW_EX
                          + "Keep editing this book or return to main menu."
                          + Style.RESET_ALL)
                    ...
                    author = validate_string(Fore.LIGHTCYAN_EX
                                             ...
                                             + Style.RESET_ALL,
                                             constants.TITLE_MAX_LEN, "author")
                    ...
                    category = validate_string(
                        Fore.LIGHTCYAN_EX + "Please update book's category: "
                    ...
                    print(
                        ...
                        + Style.RESET_ALL)
                    print(Fore.LIGHTYELLOW_EX + "Keep editing this book or "
                                                "return to main menu."
                                              + Style.RESET_ALL)
                    ...
                    description = \
                        validate_string(Fore.LIGHTCYAN_EX
                                        ...
                                        + Style.RESET_ALL,
                                        constants.DESC_MAX_LEN, "description")
                    LIBRARY.update_cell(db_row, 6, description.capitalize())
            ...
            if has_multiple_books():
                print(Fore.LIGHTRED_EX +
                      "Wrong input!\nNot much of a choice, you have only one "
                      "book, please select it...\n"
                      + Style.RESET_ALL)
            elif has_multiple_books() is False:
...
def show_book_details():
    ...
    while True:
        user_choice = input(Fore.LIGHTYELLOW_EX
                            + "\nWhich book details would you like to see?: "
                            + Style.RESET_ALL)
